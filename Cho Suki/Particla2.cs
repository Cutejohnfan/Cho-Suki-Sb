...
{
    public class Particla2 : StoryboardObjectGenerator
    {
        ...
        {            
            ...
            double timeInterval = Beatmap.GetTimingPointAt(0).BeatDuration / beatDivisor;
            // // Log(timeInterval);
                ...
                for(int y = 0; y<=particleAmount;y++)
                {
                    ...
                    int currentTime = (int)x;
                        while(sprite.PositionAt(currentTime).Y > endPosition.Y || currentTime < endTimeA) //Delayed by 1/1
                        {
                            ...
                            {
                                if(currentTime > 296776 && sprite.PositionAt(currentTime).Y > endPosition.Y)
                                {
                                    sprite.Fade(296776,297140,1,0);
                                    break;
